...
export interface OnboardingPageProps {
  ...
  // Normally saveAndFinish routes to /dashboard. If a non-invitee ever hits
  // onboarding with a `next` param threaded through, we honor it so they land
  // where they were heading. (Primary invitee path no longer hits onboarding —
  // they're routed through /auth/invitee-setup — but this stays for parity.)
  nextUrl?: string | null;
  initialProfileSeed?: {
    gender: string | null;
    ageRange: string | null;
